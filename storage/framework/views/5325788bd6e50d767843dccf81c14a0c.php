                                                ...
                                                <ul class="common-f-start">
                                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                                        data-bs-title="Atlas Stone"><img class="common-circle"
                                                            src="<?php echo e(asset('assets/images/user/12.png')); ?>"
                                                            alt="user">
                                                    </li>
                                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                                        data-bs-title="Oceana Meridian"><img class="common-circle"
                                                            src="<?php echo e(asset('assets/images/user/10.jpg')); ?>"
                                                            alt="user">
                                                    </li>
                                                </ul>
                                            </td>
                                                ...
                                                <ul class="common-f-start">
                                                    ...
                                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                                        data-bs-title="Charles Rodriguez"><img class="common-circle"
                                                            src="<?php echo e(asset('assets/images/dashboard-11/user/5.jpg')); ?>"
                                                            alt="user"></li>
                                                </ul>
                                            </td>
                                            <td> <span class="badge badge-light-warning">Pending</span></td>
                                                ...
                                                <ul class="common-f-start">
                                                    ...
                                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                                        data-bs-title="Sarah Hernandez"><img class="common-circle"
                                                            src="<?php echo e(asset('assets/images/dashboard-11/user/6.jpg')); ?>"
                                                            alt="user"></li>
                                                </ul>
                                            </td>
                                            <td> <span class="badge badge-light-primary">In Progress</span>
...
<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/cuba-laravel/resources/views/task.blade.php ENDPATH**/ ?>