                                            ...
                                            <ul class="nav nav-pills main-menu email-category" id="email-pills-tab"
                                                ...
                                                <li class="nav-item"><a class="nav-link active" id="inbox-pill-tab"
                                                        ...
                                                        aria-controls="inbox-pill" aria-selected="false"><svg
                                                            class="stroke-icon">
                                                            <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#inbox')); ?>">
                                                            </use>
                                                        </svg>
                                                ...
                                                <li class="nav-item"><a class="nav-link" id="sent-pill-tab"
                                                        ...
                                                        aria-controls="sent-pill" aria-selected="false"><svg
                                                            class="stroke-icon">
                                                            <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#sent')); ?>">
                                                            </use>
                                                        </svg>Sent</a></li>
                                                <li class="nav-item"><a class="nav-link" id="starred-pill-tab"
                                                        ...
                                                        aria-controls="starred-pill" aria-selected="false"><svg
                                                            class="stroke-icon">
                                                            <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#star')); ?>">
                                                            </use>
                                                        </svg>
                                                ...
                                                <li class="nav-item"><a class="nav-link" id="draft-pill-tab"
                                                        ...
                                                        aria-controls="draft-pill" aria-selected="false"><svg
                                                            class="stroke-icon">
                                                            <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#draft')); ?>">
                                                            </use>
                                                        </svg>
                                                ...
                                                <li class="nav-item"><a class="nav-link" id="trash-pill-tab"
                                                        ...
                                                        aria-controls="trash-pill" aria-selected="false"><svg
                                                            class="stroke-icon">
                                                            <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#trash')); ?>">
                                                            </use>
                                                        </svg>Trash</a></li>
                                                <li class="nav-item">
                                                    <ul>
                                                        <li><a href="#!"><svg class="stroke-icon stroke-primary">
                                                                    <use
                                                                        href="<?php echo e(asset('assets/svg/icon-sprite.svg#pintag')); ?>">
                                                                    </use>
                                                                </svg>Work</a></li>
                                        ...
                                        <ul class="mail-filters">
                                            <li class="common-align mail-header-option active" data-filter="important">
                                                <svg class="stroke-icon">
                                                    <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#mail')); ?>"></use>
                                                </svg><span>Important</span></li>
                                            <li class="common-align mail-header-option" data-filter="social"><svg
                                                    class="stroke-icon">
                                                    <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#goal')); ?>"></use>
                                                </svg><span>Social</span></li>
                                            <li class="common-align mail-header-option" data-filter="promotion"><svg
                                                    class="stroke-icon">
                                                    <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#tread')); ?>"></use>
                                            ...
                                            <li class="inbox-data project" data-filter="important">
                                                <div class="inbox-user">
                                                    ...
                                                    <svg class="important-mail active">
                                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#fill-star')); ?>">
                                                        </use>
                                                    </svg>
                            ...
                            <div class="mail-header-wrapper header-wrapper1">
                                <div class="mail-header1">
                                    <div class="light-square"> <svg class="btn-email">
                                            <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#back-arrow')); ?>"></use>
                                ...
                                <div class="mail-body1">
                                    <div class="light-square" data-bs-toggle="tooltip" data-bs-placement="top"
                                        data-bs-title="Achieve"><svg>
                                            <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#sms')); ?>"></use>
                                        </svg></div>
                                    <div class="light-square" data-bs-toggle="tooltip" data-bs-placement="top"
                                        data-bs-title="Bookmark"><svg class="bookmark-box">
                                            <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#bookmark')); ?>"></use>
                                        </svg></div>
                                    <div class="light-square" data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <div class="light-square bg-light-danger" data-bs-toggle="tooltip"
                                        data-bs-placement="top" data-bs-title="Trash"><svg class="stroke-danger">
                                            <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#mail')); ?>-trash"></use>
                                        </svg></div>
                                    <div class="light-square" data-bs-toggle="tooltip" data-bs-placement="top"
                            ...
                            <div class="mail-body-wrapper">
                                <div class="user-mail-wrapper">
                                    <div class="user-title">
                                        <div>
                                            <div class="rounded-border"> <img class="img-fluid"
                                                    src="<?php echo e(asset('assets/images/user/12.png')); ?>" alt="user">
                                            </div>
                                        ...
                                        <div class="inbox-options"> <span>Friday 07 Apr (4 hours ago)</span>
                                            <div class="light-square"> <svg class="important-mail">
                                                    <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#mail')); ?>-star">
                                                    </use>
                                                </svg></div>
                                            <div class="light-square" onclick="myFunction()"><svg>
                                                    <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#print')); ?>"></use>
                                                </svg></div>
                                            <div class="light-square btn-group">
                                                <div class="dropdown-toggle" role="main" data-bs-toggle="dropdown"
                                                    aria-expanded="false"><svg>
                                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#menubar')); ?>">
                                                        </use>
                                                    </svg></div>
                                    ...
                                    <div class="user-footer">
                                        <div> <svg>
                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#attchment')); ?>"></use>
                                        ...
                                        <div class="d-inline-block">
                                            <div class="attachment-file common-flex">
                                                <div class="common-flex align-items-center"><img
                                                        src="<?php echo e(asset('assets/images/email-template/pdfs.png')); ?>"
                                                        alt="pdf">
                                                    <div class="d-block">
                                                        <p>Offer_Letter.pdf</p>
                                                        <p>200KB</p>
                                                    </div>
                                                </div><a href="<?php echo e(asset('assets/pug/pages/template/text_file.pdf')); ?>"
...
<?php $__env->startSection('scripts'); ?>
    <script src="<?php echo e(asset('assets/js/blockui/custom-blockui1.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/blockui/custom-freeze1.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/trash.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/letter-box/custom-mail-pagination.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/letter-box/custom-usermail.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/editors/quill.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/editors/custom-quill.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/print.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/tooltip-init.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/cuba-laravel/resources/views/mail_box.blade.php ENDPATH**/ ?>