<?php $__env->startSection('title', 'Wescosa Dashboard'); ?>
                                    ...
                                    <div class="tab-pane fade show active" id="chats" role="tabpanel"
                                        ...
                                        <ul class="chats-user">
                                            <li class="common-space">
                                                <div class="chat-time">
                                                    <div class="active-profile"><img class="img-fluid rounded-circle"
                                                            src="<?php echo e(asset('assets/images/avtar/3.jpg')); ?>" alt="user">
                                            ...
                                            <li class="common-space">
                                                <div class="chat-time">
                                                    <div class="active-profile"><img class="img-fluid rounded-circle"
                                                            src="<?php echo e(asset('assets/images/avtar/7.jpg')); ?>" alt="user">
                                                        <div class="status bg-success"></div>
                                                    </div>
                                            ...
                                            <li class="common-space">
                                                <div class="chat-time">
                                                    <div class="active-profile"><img class="img-fluid rounded-circle"
                                                            src="<?php echo e(asset('assets/images/avtar/16.jpg')); ?>" alt="user">
                                                        <div class="status bg-success"></div>
                                                    </div>
                                            ...
                                            <li class="common-space">
                                                <div class="chat-time">
                                                    <div class="active-profile"><img class="img-fluid rounded-circle"
                                                            src="<?php echo e(asset('assets/images/avtar/4.jpg')); ?>" alt="user">
                                            ...
                                            <li class="common-space">
                                                <div class="chat-time">
                                                    <div class="active-profile"><img class="img-fluid rounded-circle"
                                                            src="<?php echo e(asset('assets/images/blog/comment.jpg')); ?>" alt="user">
                                                        <div class="status bg-warning"></div>
                                                    </div>
                                            ...
                                            <li class="common-space">
                                                <div class="chat-time">
                                                    <div class="active-profile"><img class="img-fluid rounded-circle"
                                                            src="<?php echo e(asset('assets/images/blog/4.jpg')); ?>" alt="user">
                                                        <div class="status bg-success"></div>
                                                    </div>
                                            ...
                                            <li class="common-space">
                                                <div class="chat-time">
                                                    <div class="active-profile"><img class="img-fluid rounded-circle"
                                                            src="<?php echo e(asset('assets/images/blog/12.png')); ?>" alt="user">
                                                        <div class="status bg-warning"></div>
                                                    </div>
                                            ...
                                            <li class="common-space">
                                                <div class="chat-time">
                                                    <div class="active-profile"><img class="img-fluid rounded-circle"
                                                            src="<?php echo e(asset('assets/images/blog/9.jpg')); ?>" alt="user">
                                                        <div class="status bg-warning"></div>
                                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="contacts" role="tabpanel" aria-labelledby="contacts-tab">
                                        ...
                                        <div class="contact-wrapper">
                                            ...
                                            <ul class="border-0">
                                                <li class="common-space">
                                                    <div class="chat-time"><img class="img-fluid rounded-circle"
                                                            src="<?php echo e(asset('assets/images/blog/14.png')); ?>" alt="user">
                                            ...
                                            <ul class="border-0">
                                                ...
                                                <li class="common-space">
                                                    <div class="chat-time"><img class="img-fluid rounded-circle"
                                                            src="<?php echo e(asset('assets/images/user/3.png')); ?>" alt="user">
                                                ...
                                                <li class="common-space">
                                                    <div class="chat-time"><img class="img-fluid rounded-circle"
                                                            src="<?php echo e(asset('assets/images/user/6.jpg')); ?>" alt="user">
                                                        <div> <span>Darrell Steward</span>
                                                            <p>200-300-1030</p>
                                                        </div>
                                                    </div>
                                            ...
                                            <ul class="border-0">
                                                <li class="common-space">
                                                    <div class="chat-time"><img class="img-fluid rounded-circle"
                                                            src="<?php echo e(asset('assets/images/user/1.jpg')); ?>" alt="user">
                                            ...
                                            <ul class="border-0">
                                                <li class="common-space">
                                                    <div class="chat-time"><img class="img-fluid rounded-circle"
                                                            src="<?php echo e(asset('assets/images/user/2.jpg')); ?>" alt="user">
                                    ...
                                    <div class="chat-time-chat group-chat">
                                        <ul>
                                            <li><img class="img-fluid rounded-circle"
                                                    src="<?php echo e(asset('assets/images/avtar/16.jpg')); ?>" alt="user"></li>
                                            <li><img class="img-fluid rounded-circle"
                                                    src="<?php echo e(asset('assets/images/avtar/4.jpg')); ?>" alt="user"></li>
                                            <li><img class="img-fluid rounded-circle"
                                                    src="<?php echo e(asset('assets/images/avtar/7.jpg')); ?>" alt="user"></li>
                                            <li><img class="img-fluid rounded-circle"
                                                    src="<?php echo e(asset('assets/images/dashboard-11/user/10.jpg')); ?>" alt="user">
                                            </li>
                                            <li><img class="img-fluid rounded-circle"
                                                    src="<?php echo e(asset('assets/images/avtar/4.jpg')); ?>" alt="user"></li>
                                            <li><img class="img-fluid rounded-circle"
                                                    src="<?php echo e(asset('assets/images/blog/comment.jpg')); ?>" alt="user"></li>
                                            <li><img class="img-fluid rounded-circle"
                                                    src="<?php echo e(asset('assets/images/avtar/7.jpg')); ?>" alt="user"></li>
                                            <li>
                                        ...
                                        <div class="dropdown-form dropdown-toggle" role="main" data-bs-toggle="dropdown"
                                            ...
                                            <div class="chat-icon dropdown-menu dropdown-menu-start">
                                                <div class="dropdown-item mb-2"><svg>
                                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#camera')); ?>"></use>
                                                    </svg></div>
