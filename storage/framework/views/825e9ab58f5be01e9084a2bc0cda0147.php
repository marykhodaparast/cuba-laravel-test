                                ...
                                <ul class="sidebar-left-icons nav nav-pills" id="add-product-pills-tab" role="tablist">
                                    <li class="nav-item"> <a class="nav-link active" id="detail-product-tab"
                                            ...
                                            <div class="nav-rounded">
                                                <div class="product-icons"><svg class="stroke-icon">
                                                        <use
                                                            href="<?php echo e(asset('assets/svg/icon-sprite.svg#product-detail')); ?>">
                                                        </use>
                                                    </svg></div>
                                            </div>
                                    ...
                                    <li class="nav-item"> <a class="nav-link" id="gallery-product-tab" data-bs-toggle="pill"
                                            ...
                                            <div class="nav-rounded">
                                                <div class="product-icons"><svg class="stroke-icon">
                                                        <use
                                                            href="<?php echo e(asset('assets/svg/icon-sprite.svg#product-gallery')); ?>">
                                                        </use>
                                                    </svg></div>
                                            </div>
                                            <div class="product-tab-content">
                                    ...
                                    <li class="nav-item"> <a class="nav-link" id="category-product-tab"
                                            ...
                                            <div class="nav-rounded">
                                                <div class="product-icons"><svg class="stroke-icon">
                                                        <use
                                                            href="<?php echo e(asset('assets/svg/icon-sprite.svg#product-category')); ?>">
                                                        </use>
                                                    </svg></div>
                                            </div>
                                            <div class="product-tab-content">
                                    ...
                                    <li class="nav-item"><a class="nav-link" id="pricings-tab" data-bs-toggle="pill"
                                            ...
                                            <div class="nav-rounded">
                                                <div class="product-icons"><svg class="stroke-icon">
                                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#pricing')); ?>">
                                                        </use>
                                                    </svg></div>
                                            </div>
                                            <div class="product-tab-content">
                                    ...
                                    <li class="nav-item"><a class="nav-link" id="advance-product-tab"
                                            ...
                                            <div class="nav-rounded">
                                                <div class="product-icons"><svg class="stroke-icon">
                                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#advance')); ?>">
                                                        </use>
                                                    </svg></div>
                                            </div>
                                            <div class="product-tab-content">
                                            ...
                                            <form class="row g-3 common-form">
                                                ...
                                                <div class="col-12 product-buttons"><button class="btn m-0"
                                                        ...
                                                        onclick="handleNextButtonClick('gallery-product-tab')">Next<svg>
                                                            <use
                                                                href="<?php echo e(asset('assets/svg/icon-sprite.svg#front-arrow')); ?>">
                                                            </use>
                                                        </svg></button></div>
                                            </form>
                                        </div>
                                        ...
                                        <div class="sidebar-body common-form">
                                            ...
                                            <div class="product-buttons"><button class="btn" type="button"
                                                    onclick="handleNextButtonClick('detail-product-tab')"><svg>
                                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#back-arrow')); ?>">
                                                        </use>
                                                    </svg>Previous</button><button class="btn" type="button"
                                                    onclick="handleNextButtonClick('category-product-tab')">Next<svg>
                                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#front-arrow')); ?>">
                                                        </use>
                                                    </svg></button></div>
                                        </div>
                                    </div>
                                            ...
                                            <form class="row g-3 common-form">
                                                ...
                                                <div class="col-12 product-buttons"><button class="btn" type="button"
                                                        onclick="handleNextButtonClick('gallery-product-tab')"><svg>
                                                            <use
                                                                href="<?php echo e(asset('assets/svg/icon-sprite.svg#back-arrow')); ?>">
                                                            </use>
                                                        </svg>Previous</button><button class="btn" type="button"
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('assets/js/add-product/select4-custom.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/editors/quill.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/custom-add-product.js')); ?>"></script>
...
<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/cuba-laravel/resources/views/ecommerce/products/add_products.blade.php ENDPATH**/ ?>