<?php $__env->startSection('title', 'Logistics Dashboard'); ?>
                        ...
                        <div>
                            <div class="stat-content">
                                <div class="stat-square bg-light-primary"><svg class="fill-primary">
                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#stroke-package')); ?>"> </use>
                                    </svg></div>
                                <div>
                        ...
                        <div>
                            <div class="stat-content">
                                <div class="stat-square bg-light-secondary"><svg class="fill-secondary">
                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#stroke-progress-delivery')); ?>">
                                        </use>
                                    </svg></div>
                                <div>
                        ...
                        <div>
                            <div class="stat-content">
                                <div class="stat-square bg-light-warning"><svg class="fill-warning">
                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#stroke-delivered')); ?>"> </use>
                                    </svg></div>
                                <div>
                        ...
                        <div class="recent-table table-responsive custom-scrollbar">
                            <table class="table" id="shipment-tracking-table">
                                ...
                                <tbody>
                                    <tr class="inbox-data">
                                        <td> </td>
                                        <td> <a href="<?php echo e(route('admin.order_details')); ?>" target="_blank">#FH83P3</a></td>
                                        <td>FedEx</td>
                                        <td>New York</td>
                                        <td>Boston</td>
                                        <td>Denver</td>
                                    ...
                                    <tr class="inbox-data">
                                        <td> </td>
                                        <td> <a href="<?php echo e(route('admin.order_details')); ?>" target="_blank">#SD56Q3</a></td>
                                        <td>UPS</td>
                                        <td>Miami</td>
                                        <td>Seattle</td>
                                        <td>Chicago</td>
                                    ...
                                    <tr class="inbox-data">
                                        <td> </td>
                                        <td> <a href="<?php echo e(route('admin.order_details')); ?>" target="_blank">#DR45E4</a></td>
                                        <td>DHL</td>
                                        <td>Houston</td>
                                        <td>Boston</td>
                                        <td>Houston</td>
                                    ...
                                    <tr class="inbox-data">
                                        <td> </td>
                                        <td> <a href="<?php echo e(route('admin.order_details')); ?>" target="_blank">#DE56H4</a></td>
                                        <td>USPS</td>
                                        <td>Houston</td>
                                        <td>New York</td>
                                        <td>Francisco</td>
                                    ...
                                    <tr class="inbox-data">
                                        <td> </td>
                                        <td> <a href="<?php echo e(route('admin.order_details')); ?>" target="_blank">#RT89A1</a></td>
                                        <td>FedEx</td>
                                        <td>Germany</td>
                                        <td>Houston</td>
                                        <td>Seattle</td>
                                    ...
                                    <tr class="inbox-data">
                                        <td> </td>
                                        <td> <a href="<?php echo e(route('admin.order_details')); ?>" target="_blank">#ED58B5</a></td>
                                        <td>DHL</td>
                                        <td>Miami</td>
                                        <td>Boston</td>
                                        <td>Denver</td>
                                    ...
                                    <tr class="inbox-data">
                                        <td> </td>
                                        <td> <a href="<?php echo e(route('admin.order_details')); ?>" target="_blank">#TY71S1</a></td>
                                        <td>USPS</td>
                                        <td>Atlanta</td>
                                        <td>Denver</td>
                                        <td>Dallas</td>
                                    ...
                                    <tr class="inbox-data">
                                        <td> </td>
                                        <td> <a href="<?php echo e(route('admin.order_details')); ?>" target="_blank">#RT66W4</a></td>
                                        <td>FedEx</td>
                                        <td>Dallas</td>
                                        <td>Chicago</td>
                                        <td>Orlando</td>
                                    ...
                                    <tr class="inbox-data">
                                        <td> </td>
                                        <td> <a href="<?php echo e(route('admin.order_details')); ?>" target="_blank">#ER89Q3</a></td>
                                        <td>DHL</td>
                                        <td>Orlando</td>
                                        <td>Portland</td>
                                        <td>Seattle</td>
                                    ...
                                    <tr class="inbox-data">
                                        <td> </td>
                                        <td> <a href="<?php echo e(route('admin.order_details')); ?>" target="_blank">#QQ66D2</a></td>
                                        <td>UPS</td>
                                        <td>Boston</td>
                                        <td>Las Vegas</td>
                                        <td>San Diego</td>
                        ...
                        <div class="recent-table table-responsive custom-scrollbar">
                            <table class="table" id="vehicle-table">
                                ...
                                <tbody>
                                    <tr class="inbox-data">
                                        <td> </td>
                                        <td> <a href="<?php echo e(route('admin.order_details')); ?>">#V001</a></td>
                                        <td>Active</td>
                                        <td>
                                            <div class="common-flex align-items-center"><img
                                                    class="img-fluid rounded-circle"
                                                    src="<?php echo e(asset('assets/images/dashboard-12/user/13.png')); ?>"
                                    ...
                                    <tr class="inbox-data">
                                        <td> </td>
                                        <td> <a href="<?php echo e(route('admin.order_details')); ?>">#V002</a></td>
                                        <td>Maintenance</td>
                                        <td>
                                            <div class="common-flex align-items-center"><img
                                                    class="img-fluid rounded-circle"
                                                    src="<?php echo e(asset('assets/images/dashboard-12/user/8.png')); ?>"
                                    ...
                                    <tr class="inbox-data">
                                        <td> </td>
                                        <td> <a href="<?php echo e(route('admin.order_details')); ?>">#V003</a></td>
                                        <td>Active</td>
                                        <td>
                                            <div class="common-flex align-items-center"><img
                                                    class="img-fluid rounded-circle"
                                                    src="<?php echo e(asset('assets/images/dashboard-12/user/1.png')); ?>"
                                    ...
                                    <tr class="inbox-data">
                                        <td> </td>
                                        <td> <a href="<?php echo e(route('admin.order_details')); ?>">#V004</a></td>
                                        <td>Active</td>
                                        <td>
                                            <div class="common-flex align-items-center"><img
                                                    class="img-fluid rounded-circle"
                                                    src="<?php echo e(asset('assets/images/dashboard-12/user/5.png')); ?>"
                                    ...
                                    <tr class="inbox-data">
                                        <td> </td>
                                        <td> <a href="<?php echo e(route('admin.order_details')); ?>">#V005</a></td>
                                        <td>Maintenance</td>
                                        <td>
                                            <div class="common-flex align-items-center"><img
                                                    class="img-fluid rounded-circle"
                                                    src="<?php echo e(asset('assets/images/dashboard-12/user/7.png')); ?>"
                                    ...
                                    <tr class="inbox-data">
                                        <td> </td>
                                        <td> <a href="<?php echo e(route('admin.order_details')); ?>">#V006</a></td>
                                        <td>Maintenance</td>
                                        <td>
                                            <div class="common-flex align-items-center"><img
                                                    class="img-fluid rounded-circle"
                                    ...
                                    <tr class="inbox-data">
                                        <td> </td>
                                        <td> <a href="<?php echo e(route('admin.order_details')); ?>">#V007</a></td>
                                        <td>Active</td>
                                        <td>
                                            <div class="common-flex align-items-center"><img
                                                    class="img-fluid rounded-circle"
                                    ...
                                    <tr class="inbox-data">
                                        <td> </td>
                                        <td> <a href="<?php echo e(route('admin.order_details')); ?>">#V008</a></td>
                                        <td>Active</td>
                                        <td>
                                            <div class="common-flex align-items-center"><img
                                                    class="img-fluid rounded-circle"
                                    ...
                                    <tr class="inbox-data">
                                        <td> </td>
                                        <td> <a href="<?php echo e(route('admin.order_details')); ?>">#V009</a></td>
                                        <td>Active</td>
                                        <td>
                                            <div class="common-flex align-items-center"><img
                                                    class="img-fluid rounded-circle"
                                    ...
                                    <tr class="inbox-data">
                                        <td> </td>
                                        <td> <a href="<?php echo e(route('admin.order_details')); ?>">#V0010</a></td>
                                        <td>Active</td>
                                        <td>
                                            <div class="common-flex align-items-center"><img
                                                    class="img-fluid rounded-circle"
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('assets/js/dashboard/dashboard_13.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/height-equal.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/cuba-laravel-test/resources/views/dashboards/logistics_dashboard.blade.php ENDPATH**/ ?>