                                    ...
                                    <div class="common-sort-card">
                                        ...
                                        <ul class="files-left-icons file-type-icons">
                                            <li><a id="folder-files-tab" href="#!">
                                                    <div><svg>
                                                            <use
                                                                href="<?php echo e(asset('assets/svg/icon-sprite.svg#folder-structure')); ?>">
                                                            </use>
                                            ...
                                            <li> <a id="document-files-tab" href="#!">
                                                    <div><svg>
                                                            <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#doc-file')); ?>">
                                                            </use>
                                            ...
                                            <li><a id="images-files-tab" href="#!">
                                                    <div><svg>
                                                            <use
                                                                href="<?php echo e(asset('assets/svg/icon-sprite.svg#image-file')); ?>">
                                                            </use>
                                            ...
                                            <li> <a id="pdf-files-tab" href="#!">
                                                    <div><svg>
                                                            <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#pdf-file')); ?>">
                                                            </use>
                                            ...
                                            <li> <a id="xml-files-tab" href="#!">
                                                    <div><svg>
                                                            <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#xml-file')); ?>">
                                                            </use>
                                            ...
                                            <li> <a id="sql-files-tab" href="#!">
                                                    <div><svg>
                                                            <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#sql-file')); ?>">
                                                            </use>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="pricing-plan">
                                                ...
                                                <img class="bg-img" src="<?php echo e(asset('assets/images/dashboard/folder.png')); ?>"
                                                    alt="folder">
                                            </div>
                                        </li>
                                        <li>
                                            <div class="pricing-plan">
                                                ...
                                                <img class="bg-img"
                                                    src="<?php echo e(asset('assets/images/dashboard/folder1.png')); ?>"
                                                    alt="folder">
                                            </div>
                                        </li>
                                    </ul>
                        ...
                        <div class="common-file-manager">
                            <div class="filemanger">
                                ...
                                <div class="file-manager-grid block-wrapper">
                                    ...
                                    <div class="file">
                                        <div class="image-preview"><img class="img-fluid"
                                                src="<?php echo e(asset('assets/images/other-images/sea.jpg')); ?>" alt="mountain">
                                        </div>
                                        <div class="common-space">
                                ...
                                <div class="folderEmpty"><svg>
                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#folder-empty')); ?>"></use>
                                    </svg>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('assets/js/custom_filemanager.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/cuba-laravel/resources/views/file_manager.blade.php ENDPATH**/ ?>