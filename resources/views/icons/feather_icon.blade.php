    ...
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.wescosa_dashboard') }}">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row icon-lists feather-icons">
                            ...
                            <div class="col-12 col-sm-6 col-xl-4">
                                <div class="d-flex"><i data-feather="codesandbox"></i>
                                    <div class="flex-grow-1 align-self-center">
                                        <h6 class="mt-0">codesandbox</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-xl-4">
                            ...
                            <div class="col-12 col-sm-6 col-xl-4">
                                <div class="d-flex"><i data-feather="columns"></i>
                                    <div class="flex-grow-1 align-self-center">
                                        <h6 class="mt-0">columns</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-xl-4">
                                <div class="d-flex"><i data-feather="divide"></i>
                                    <div class="flex-grow-1 align-self-center">
                                        <h6 class="mt-0">divide</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-xl-4">
                                <div class="d-flex"><i data-feather="divide-circle"></i>
                                    <div class="flex-grow-1 align-self-center">
                                        <h6 class="mt-0">divide-circle</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-xl-4">
                                <div class="d-flex"><i data-feather="divide-square"></i>
                                    <div class="flex-grow-1 align-self-center">
                                        <h6 class="mt-0">divide-square</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-xl-4">
                                <div class="d-flex"><i data-feather="dribbble"></i>
                                    <div class="flex-grow-1 align-self-center">
                                        <h6 class="mt-0">dribbble</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-xl-4">
                                <div class="d-flex"><i data-feather="figma"></i>
                                    <div class="flex-grow-1 align-self-center">
                                        <h6 class="mt-0">figma</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-xl-4">
                                <div class="d-flex"><i data-feather="framer"></i>
                                    <div class="flex-grow-1 align-self-center">
                                        <h6 class="mt-0">framer</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-xl-4">
                                <div class="d-flex"><i data-feather="frown"></i>
                                    <div class="flex-grow-1 align-self-center">
                                        <h6 class="mt-0">frown</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-xl-4">
                                <div class="d-flex"><i data-feather="hexagon"></i>
                                    <div class="flex-grow-1 align-self-center">
                                        <h6 class="mt-0">hexagon</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-xl-4">
                                <div class="d-flex"><i data-feather="key"></i>
                                    <div class="flex-grow-1 align-self-center">
                                        <h6 class="mt-0">key</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-xl-4">
                                <div class="d-flex"><i data-feather="meh"></i>
                                    <div class="flex-grow-1 align-self-center">
                                        <h6 class="mt-0">meh</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-xl-4">
                                <div class="d-flex"><i data-feather="mouse-pointer"></i>
                                    <div class="flex-grow-1 align-self-center">
                                        <h6 class="mt-0">mouse-pointer</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-xl-4">
                                <div class="d-flex"><i data-feather="pen-tool"></i>
                                    <div class="flex-grow-1 align-self-center">
                                        <h6 class="mt-0">pen-tool</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-xl-4">
                            ...
                            <div class="col-12 col-sm-6 col-xl-4">
                                <div class="d-flex"><i data-feather="smile"></i>
                                    <div class="flex-grow-1 align-self-center">
                                        <h6 class="mt-0">smile</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-xl-4">
                            ...
                            <div class="col-12 col-sm-6 col-xl-4">
                                <div class="d-flex"><i data-feather="tool"></i>
                                    <div class="flex-grow-1 align-self-center">
                                        <h6 class="mt-0">tool</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-xl-4">
                                <div class="d-flex"><i data-feather="trello"></i>
                                    <div class="flex-grow-1 align-self-center">
                                        <h6 class="mt-0">trello</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-xl-4">
                                <div class="d-flex"><i data-feather="x-octagon"></i>
                                    <div class="flex-grow-1 align-self-center">
                                        <h6 class="mt-0">x-octagon</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
