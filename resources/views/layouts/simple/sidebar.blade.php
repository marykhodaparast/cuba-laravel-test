...
<div class="sidebar-wrapper" data-sidebar-layout="stroke-svg">
    <div>
        ...
        <div class="logo-icon-wrapper"><a href="{{ route('admin.wescosa_dashboard') }}"><img class="img-fluid"
                    src="{{ asset('assets/images/logo/logo-icon.png') }}" alt=""></a></div>
        <nav class="sidebar-main">
            <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    <li class="back-btn"><a href="{{ route('admin.wescosa_dashboard') }}"><img class="img-fluid"
                    ...
                    {{-- <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><label
                        ...
                        <ul class="sidebar-submenu">
                            <li><a class="lan-4" href="{{ route('admin.wescosa_dashboard') }}">Default</a></li>
                            ...
                            <li><label class="badge badge-light-success">New</label><a
                                    href="{{ route('admin.crm_dashboard') }}">CRM</a>
                            </li>
                            <li><label class="badge badge-light-success">New</label><a
                                    href="{{ route('admin.analytics_dashboard') }}">Analytics</a></li>
                            <li><label class="badge badge-light-success">New</label><a
                                    href="{{ route('admin.hr_dashboard') }}">HR</a>
                            </li>
                            <li><label class="badge badge-light-success">New</label><a
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"> </i><a
                            class="sidebar-link sidebar-title link-nav" href="{{ route('admin.kanban') }}"><svg
                                class="stroke-icon">
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li><label class="badge badge-light-success">New</label><a
                                    href="{{ route('admin.user_list') }}">User
                                    List</a></li>
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a
                            class="sidebar-link sidebar-title link-nav" href="{{ route('admin.task') }}"><svg
                                class="stroke-icon">
                                <use href="{{ asset('assets/svg/icon-sprite.svg#stroke-task') }}"></use>
                            </svg><svg class="fill-icon">
                                <use href="{{ asset('assets/svg/icon-sprite.svg#fill-task') }}"> </use>
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a
                            class="sidebar-link sidebar-title link-nav"
                            href="{{ route('admin.calendar_basic') }}"><svg class="stroke-icon">
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a
                            class="sidebar-link sidebar-title link-nav" href="{{ route('admin.to_do') }}"><svg
                                class="stroke-icon">
                        ...
                        <ul class="sidebar-submenu">
                            <li><a class="submenu-title" href="javascript:void(0)">Form Controls<span
                                ...
                                <ul class="sidebar-submenu">
                                    ...
                                    <li><a href="{{ route('admin.radio_checkbox_control') }}">Checkbox & Radio</a>
                                    </li>
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li><label class="badge badge-light-success">New</label><a
                                    href="{{ route('admin.divider') }}">Divider</a>
                            </li>
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li><label class="badge badge-light-success">New</label><a
                                    href="{{ route('admin.ratios') }}">Ratios</a>
                            </li>
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li><label class="badge badge-light-success">New</label><a
                                    href="{{ route('admin.flash_icon') }}">Flash
                                    Icons</a></li>
                        </ul>
                    </li>
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a
                            class="sidebar-link sidebar-title link-nav" href="{{ route('admin.buttons') }}"><svg
                                class="stroke-icon">
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a
                            class="sidebar-link sidebar-title link-nav"
                            href="{{ route('admin.internationalization') }}"><svg class="stroke-icon">
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li><a href="{{ route('admin.login_one') }}" target="_blank">Login with bg image</a>
                            </li>
                            <li><a href="{{ route('admin.login_two') }}" target="_blank">Login with image two </a>
                            </li>
                            <li><a href="{{ route('admin.login_three') }}" target="_blank">Login With Image
                                    Three</a></li>
                            <li><a href="{{ route('admin.login_with_tooltip') }}" target="_blank">Login with
                                    tooltip</a>
                            </li>
                            ...
                            <li><a href="{{ route('admin.sign_up_with_bg_image') }}" target="_blank">Register with
                                    Bg Image
                                </a></li>
                            <li><a href="{{ route('admin.sign_up_with_image_two') }}" target="_blank">Register with
                                    image
                                    two</a></li>
                            <li><a href="{{ route('admin.sign_up_wizard') }}" target="_blank">Register wizard</a>
                            </li>
                            <li><a href="{{ route('admin.account_restricted') }}" target="_blank">Account
                                    Restricted</a>
                            </li>
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a
                            class="sidebar-link sidebar-title link-nav" href="{{ route('admin.faq') }}"><svg
                                class="stroke-icon">
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a
                            class="sidebar-link sidebar-title link-nav"
                            href="{{ route('admin.subscribed_user') }}"><svg class="stroke-icon">
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li>
                                <label class="badge badge-light-success">New</label><a
                                    href="{{ route('admin.gallery_placeholder') }}">Gallery Placeholder</a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a
                            class="sidebar-link sidebar-title link-nav"
                            href="{{ route('admin.knowledgebase') }}"><svg class="stroke-icon">
                    ...
                    <li class="sidebar-list"><i class="fa-solid fa-thumbtack"></i><a --}}
                            class="sidebar-link sidebar-title link-nav"
                            href="{{ route('admin.support_ticket') }}"><svg class="stroke-icon">
