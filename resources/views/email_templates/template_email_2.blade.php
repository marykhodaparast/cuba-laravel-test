...
<head>
    ...
    <title>Email Template 2 Cuba - Premium Admin Template</title>
            ...
            <tr>
                <td>
                    ...
                    <table class="slider" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tbody>
                            <tr>
                                <th align="center" width="40%"><img
                                        src="{{ asset('assets/images/email-template/slider.jpg') }}" alt=""
                                        style="margin-bottom: -5px;"></th>
                                <th width="60%" style="background-color: #7366FF;padding: 30px;">
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tbody>
                                            <tr>
                                                <td
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="text-button white-button"
                                                    style="font-size:14px; line-height:18px; text-align:center; text-transform:uppercase; padding:10px; background:#ffffff; color:#838383; font-weight:bold;">
                                                    <a href="#!" target="_blank"
                                                        style="color:#4e54cb; text-decoration:none;"><span
                                                            style="color:#fc564a; text-decoration:none;">shop
                                                            now</span></a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <td>
                                    <div class="product-box hover">
                                        ...
                                        <div class="product-info">
                                            <div class="rating"><i class="fa-solid fa-star"
                                                    style="color:#ffb829;"></i><i class="fa-solid fa-star"
                                                    style="color:#ffb829;"></i><i class="fa-solid fa-star"
                                                    style="color:#ffb829;"></i><i class="fa-solid fa-star"
                                                    style="color:#ffb829;"></i><i class="fa-solid fa-star"
                                                    style="color:#ffb829;"></i></div><a href="#!"
                                                tabindex="0">
                        ...
                        <tbody>
                            <tr class="add-with-banner" align="center">
                                <td><a href="#!"><img
                                            ...
                                            alt="product" style="width: 100%;"></a></td>
                            </tr>
                        </tbody>
                    </table>
                    <table border="0" cellpadding="0" cellspacing="0" align="center" style="margin-top:30px;">
                        <tbody>
                            <tr>
                                <td><img src="{{ asset('assets/images/email-template/banner-2.jpg') }}" alt=""
                                        style="width: 100%;"></td>
                            </tr>
                        </tbody>
                    </table>
                            ...
                            <tr>
                                <td align="center">
                                    <table class="display-width-inner" align="center" border="0" cellpadding="0"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td align="center" style="width: 40%;"><img
                                                ...
                                                <td align="center" style="background-color: #fafafa;width: 60%;">
                                                    ...
                                                    <div
                                                        ...
                                                        <span class="txt-price1"
                                                            ...
                                                            class="txt-price2">   </span>$20.90</div>
                                                    <div
