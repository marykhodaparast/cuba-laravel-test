    ...
    <div class="container-fluid autofill-data-tables">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0 card-no-border">
                        ...
                        <p class="f-m-light mt-1">If you are looking to emulate the UI of spreadsheet
                            programs such as Excel with DataTables, the combination of KeyTable and AutoFill
                            will take you a long way there!</p>
                    </div>
                    <div class="card-body">
                        <div class="dt-ext table-responsive custom-scrollbar">
                            <table class="display table-striped keytable-table" id="keytable">
                                <thead>
                                    <tr>
                                        <th>Employee Name</th>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0 card-no-border">
                        <h5 class="mb-3">Multi-Level Collections</h5>
                        <p class="f-m-light mt-1">Keyboard navigation is essential for fast navigation of a
                            table operations and also for good accessibility. Buttons provides the ability
                            to give each button a key binding - i.e. a key combination that when pressed
                            will activate the button's action.
                            The key binding can be given as a single character if you wish to listen for an
                            unmodified key press, or as an object if you wish it to only be activated when a
                            modifier key such as shift, alt, etc, is pressed.</p>
                    </div>
                    <div class="card-body">
                        <div class="dt-ext table-responsive custom-scrollbar multi-level-table">
                            <table class="display table-striped" id="multilevel-btn">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Theme Name</th>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0 card-no-border">
                        <h5 class="mb-3">Header and Footer Fixed</h5>
                        <p class="f-m-light mt-1">When displaying tables with a particularly large amount of
                            data shown on each page, it can be useful to have the table's header and footer
                            fixed to the top or bottom of the scrolling window FixedHeader provides the
                            ability to fix in place both. These are controlled by the options
                            fixedHeader.header and fixedHeader.footer. Either can be optionally enabled, or
                            as is the case in this example, both enabled.</p>
                    </div>
                    <div class="card-body">
                        <div class="dt-ext table-responsive custom-scrollbar header-footer-table">
                            <table class="display table-striped" id="fixed-header-footer">
                                <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Position</th>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0 card-no-border">
                        <h5 class="mb-3">Immediately Show Hidden Details</h5>
                        <p class="f-m-light mt-1">Responsive has the ability to display the details that it
                            has hidden in a variety of different ways. Its default is to allow the end user
                            to toggle the the display by clicking on a row and showing the information in a
                            DataTables child row. At times it can be useful not to require end user
                            interaction to display the hidden data in a responsive manner, which can be done
                            with the childRowImd-flexte display type.</p>
                    </div>
                    <div class="card-body">
                        <div class="dt-ext table-responsive custom-scrollbar">
                            <table class="display table-striped nowrap" id="show-hidden-row">
                                <thead>
                                    <tr>
                                        <th>First name</th>
                                        <th>Last name</th>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0 card-no-border">
                        <h5 class="mb-3">Full Row Selection</h5>
                        <p class="f-m-light mt-1">The rowReorder.selector option provides the ability to
                            define which element in a table row will provide the row reordering handle to
                            the end user. By default only the first cell in the row will trigger the
                            reordering action. This example shows the entire row being able to start the
                            reorder. Simply click and drag anywhere on the row. Additionally, the column
                            that defines the row order is hidden by default, making the table a simple
                            orderable list.</p>
                    </div>
                    <div class="card-body">
