                        ...
                        <div class="row">
                            <div class="col-xl-6 col-md-8 offset-xl-3 offset-md-2">
                                    ...
                                    <div class="card">
                                        <div class="animate-widget">
                                            ...
                                            <div class="text-center p-25">
                                                <p class="text-muted mb-0">Denouncing pleasure and praising
                                ...
                                <form class="theme-form text-center">
                                    <div class="mb-3"><select class="form-select input input--dropdown js-animations">
                                        ...
                                        </select></div><button class="js-triggeraNimation btn btn-primary">Animate
                                        it</button>
                                </form>
                            </div>
                        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>How to use it?</h5>
                        <p class="f-m-light mt-1">All you have to do is to add animation name class
                            attribute to html element, like :<code>Fade</code></p>
                    </div>
