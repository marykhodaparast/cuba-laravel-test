    ...
    <div class="container-fluid">
        ...
        It's a separate element, as animating opacity is faster than rgba().-->
                    ...
                    <div class="card-body">
                        <div><i class="text-muted"> // The Below Function is example of how to initlize
                            ...
                            <div class="line"><span></span> &lt;script&gt;
                                <span></span><br><code>  AOS.init();</code><br><span> &lt;</span> /script
                                <span> &gt; </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5>How to use it?</h5>
                        <p class="f-m-light mt-1">All you have to do is to add <code>data-aos</code>
                            attribute to html element, like so:</p>
                    </div>
                    <div class="card-body">
                        <div class="txt-primary"><span> &lt;</span> div data-aos="animation_name" <span>
                                &gt; </span></div>
                    </div>
                </div>
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="f-m-light mt-1">These settings can be set both on certain elements, or as
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Anchor element, whose offset will be counted to trigger animation
                                        instead of actual elements offset</td>
                                    <td>#selector</td>
                                    <td>null</td>
                                </tr>
                                <tr>
                                    <td><em><code>data-aos-anchor-placement</code></em></td>
                                    <td>Anchor placement - which one position of element on the screen
                                        should trigger animation</td>
                                    <td>top-center</td>
                                    <td>top-bottom</td>
                                </tr>
                                <tr>
                                    <td><em><code>data-aos-once</code></em></td>
                                    <td>Choose wheter animation should fire once, or every time you scroll
                                        up/down to element</td>
                                    <td>true</td>
                                    <td>false</td>
                                </tr>
                            </tbody>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5> Animation</h5>
                        <p class="f-m-light mt-1">There are several predefined animations you can use
                            already:</p>
                    </div>
                    <div class="card-body">
                        <ul class="line">
                            <li>
                                <h6>Fade animations:</h6>
                                <ol class="ps-4 mb-4">
                                    <li>fade</li>
                                    <li>fade-up</li>
                                    <li>fade-down</li>
