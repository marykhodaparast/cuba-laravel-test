...
@section('main_content')
        ...
        <div class="col-12 ps-5">
            ...
            <div class="job-info">
                <div class="row">
                    ...
                    <div class="col-md-2"><small>Customer</small><br><span class="bold-text">{{ $data->customer }}</span>
                    </div>
                    ...
                    <div class="col-md-1"><small>Feeders</small><br><span class="bold-text">{{ $data->feeders }}</span>
                    </div>
    ...
    <div class="modal-right">
        ...
        <form method="POST" action="/orders/update_eta_ata/" style="margin-top: 15px;">
            ...
            <button type="button" id="qr-btn" class="btn btn-success mt-2" onclick="handleQRClick()">Generate
                QR</button>
        </form>
    </div>
@endsection
